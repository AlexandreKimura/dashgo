...
import { Box, Button, Checkbox, Flex, Heading, Icon, Link, Table, Tbody, Th, Thead, Tr, Td, Text, useBreakpointValue, Spinner } from "@chakra-ui/react";
      ...
      >
        ...
        <Box flex="1" borderRadius={8} bg="gray.800" p="8">
          ...
          { isLoading ? (
            ...
            <Flex justify="center">
              <Text>Falha ao obter os dados do servidor</Text>
            </Flex>
          ) : (
            <>
